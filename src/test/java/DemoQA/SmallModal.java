...
public void smallModal() {
	...
	modal.click();
	driver.getPageSource().contains("Modal Dialogs");
	...
	public void beforeMethod() throws IOException{
		try {
		FileInputStream input = new FileInputStream("C:\\Users\\Admin\\Desktop\\ExcelrDemoQAProject-2\\src\\test\\resources\\Properties\\SmallModal.properties");
		prop.load(input);
