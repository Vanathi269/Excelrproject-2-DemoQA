...
public void alertButton() {
	...
	driver.findElement(By.xpath(prop.getProperty("alertHandling"))).click();
	...
	public void beforeMethod() throws IOException{
		try {
		FileInputStream input = new FileInputStream("C:\\Users\\Admin\\Desktop\\ExcelrDemoQAProject-2\\src\\test\\resources\\properties\\AlertsButton.properties");
		prop.load(input);
